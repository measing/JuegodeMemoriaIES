...
import { updateStats, renderLeaderboard, renderMobileProfile, getSoloLeaderboard, replaceSoloLeaderboard, setSharedLeaderboard, getSoloStats, replaceSoloStats, initRulesModal, initViewNavigation, toggleSettingsView, initCardSkinStore } from './ui.js?v=124';
import { initAudioControls } from './audio.js?v=75';
import { initI18n, translatePage } from './i18n.js?v=11';
import { initFirebaseIntegration } from './firebase-service.js?v=17';
